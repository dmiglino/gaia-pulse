...
| Comando | Antes de v3 | Después de la Fase 2 | Después de la 4.4.7 | Después de la 4.4.8 | Después de la 4.4.9 | Después de la 4.4.10 | Después de la 7.1 | Después de la 7.2 | Después de la 7.3 | Después de la 7.4 | Después de la 7.5 | Después de la 7.6 | Después de la 7.7 | Después de la 7.8 | Después de la 7.9 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `pytest tests/` | 117 passed | **163 passed** | **498 passed** | **531 passed** | **545 passed** | **569 passed** | **804 passed** | **811 passed** | **820 passed** | **829 passed** | **834 passed** | **843 passed** | 843 (sin cambio) | **848 passed** (+5: los tres tests de edición inline más los dos adversariales que agregó la corrección de seguridad) | **853 passed** (+5: los cuatro tests de segmentación de `TestSegmentarTemasMezclados` más el que blinda la mejora de preferencias mixtas que encontró `code-health-qa`) |
