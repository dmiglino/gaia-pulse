...
class WorkoutRepository(BaseRepository[WorkoutSession]):
    ...
    def get_household_sessions(
        ...
        stmt = (
            ...
            .options(
                selectinload(WorkoutSession.participants)
                .selectinload(WorkoutParticipant.exercises)
            )
    ...
    def get_today_sessions(self, household_id: int, today: date) -> list[WorkoutSession]:
        return self.get_household_sessions(household_id, limit=20, start_date=today)
